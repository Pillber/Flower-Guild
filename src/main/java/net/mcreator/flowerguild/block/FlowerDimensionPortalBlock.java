...
package net.mcreator.flowerguild.block;
...
import net.mcreator.flowerguild.world.teleporter.FlowerDimensionTeleporter;
import net.mcreator.flowerguild.world.teleporter.FlowerDimensionPortalShape;

import java.util.Optional;

public class FlowerDimensionPortalBlock extends NetherPortalBlock {
	public FlowerDimensionPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<FlowerDimensionPortalShape> optional = FlowerDimensionPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new FlowerDimensionPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
		...
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			if (entity.isOnPortalCooldown()) {
				entity.setPortalCooldown();
					...
					new ResourceLocation("flower_guild:flower_dimension"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos,
						ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("flower_guild:flower_dimension")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new FlowerDimensionTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
