 ...
 *
 */
package net.mcreator.flowerguild;
...
@Mod("flower_guild")
public class FlowerGuildMod {
	public static final Logger LOGGER = LogManager.getLogger(FlowerGuildMod.class);
	public static final String MODID = "flower_guild";

	public FlowerGuildMod() {
